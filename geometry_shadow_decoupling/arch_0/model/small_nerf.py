...
class NeRFSmall(nn.Module):
    ...
    the final image, since this task is covered by the Integrator class.
    ...
    def forward(
        ...
        The color network estimate the color of each particle along the input rays. It employes the geometric features, and the viewing direction.
