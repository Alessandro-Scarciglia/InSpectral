...
class NeuralRenderer(nn.Module):
    ...
    def forward(
        ...
        """
        This method implements the sequence of functions which transform the input rays
        in a full rendered image, along with the scene depth estimation and the sparsity loss.
